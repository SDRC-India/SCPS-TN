...
public class Constants {
	...
	public static final class Web {
		...
		public static final String DATA_ALREADY_PUBLISHED = "error.data.published";
		...
		public static final String NO_OF_INSTITUTION = "assets/img/institution.png";
		public static final String INSTITUTION_CAPACITY = "assets/img/capacity.png";
		public static final String NO_OF_CHILDREN = "assets/img/special_need.png";
